...
const (
	...
	//AV_CODEC_ID_MPEG2VIDEO_XVMC             = int(C.AV_CODEC_ID_MPEG2VIDEO_XVMC) // Removed in 4.x
	...
	//AV_CODEC_ID_VIMA                        = int(C.AV_CODEC_ID_VIMA) // Removed in 4.x
	...
	//AV_CODEC_ID_VOXWARE                     = int(C.AV_CODEC_ID_VOXWARE) // Removed in 4.x
