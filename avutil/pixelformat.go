...
//
// C-Function-Old: avcodec_get_chroma_sub_sample
// C-Function: av_pix_fmt_get_chroma_sub_sample
func (p PixelFormat) ChromaSubSample() (int, int) {
	var h, v int
	C.av_pix_fmt_get_chroma_sub_sample((C.enum_AVPixelFormat)(p), (*C.int)(unsafe.Pointer(&h)), (*C.int)(unsafe.Pointer(&v)))
	return h, v
}
...
//
// C-Function: avcodec_pix_fmt_to_codec_tag
